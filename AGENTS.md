...
## 0. Project Identity
* **Name:** Election Sentiment Tracker
* **One-line value:** Cuts civic sentiment analysis latency from 7 days to 2 hours for campaign planners — capturing real-time voter alignment.
