...
export const ELECTION_DATA = {
  ...
  // ── Provincial Data ──
  provinces: [
    { name: 'Lusaka', voters: 1430889, upnd: 43, pf: 39, lean: 'CONTESTED', classification: 'Urban toss-up, HH edge', baseline2021: 'ECZ 2021: HH led Lusaka, but urban anti-incumbent pressure is high.', issueDrivers: ['cost of living', 'load shedding', 'youth jobs', 'market prices', 'free education proof'], rationale: 'Lusaka keeps a narrow HH edge because 2021 support, free education and CDF visibility still matter, but the model sharply discounts UPND for electricity, food prices, rent, transport and youth job frustration.', confidence: 'medium' },
    { name: 'Copperbelt', voters: 1296446, upnd: 40, pf: 41, lean: 'CONTESTED', classification: 'Mining belt toss-up, opposition edge', baseline2021: 'ECZ 2021: HH led Copperbelt, so a clean opposition anchor is not justified.', issueDrivers: ['mining jobs', 'contractor payments', 'load shedding', 'casual labour', 'local supplier economy'], rationale: 'Copperbelt is moved from opposition anchor to battleground. The opposition gets a small edge from mining-community job pressure and urban cost anger, while HH retains a credible route through CDF, mine investment messaging and student/youth programmes.', confidence: 'medium' },
    { name: 'Eastern', voters: 1129444, upnd: 35, pf: 44, lean: 'PF', classification: 'Opposition leaning', baseline2021: 'ECZ 2021: Lungu/PF led Eastern, so an HH province lead was unsupported.', issueDrivers: ['PF legacy vote', 'Makebi transfer', 'Kalaba pockets', 'agriculture', 'fertiliser and maize prices'], rationale: 'Eastern is opposition-leaning because the 2021 baseline favoured PF and the 2026 lane has Makebi/Eastern transfer potential. HH can still compete through agriculture delivery, CDF and incumbency, but not as the current leader.', confidence: 'high' },
    { name: 'Southern', voters: 1103275, upnd: 75, pf: 12, lean: 'UPND', classification: 'UPND anchor', baseline2021: 'ECZ 2021: HH won Southern overwhelmingly.', issueDrivers: ['regional loyalty', 'cattle and agriculture', 'water', 'drought recovery', 'infrastructure'], rationale: 'Southern remains the strongest HH anchor. The model trims the 2021 landslide for drought, water and cost-of-living fatigue, but there is no evidence strong enough to remove UPND leadership.', confidence: 'high' },
    { name: 'Central', voters: 760000, upnd: 51, pf: 33, lean: 'UPND', classification: 'UPND leaning, mixed belt', baseline2021: 'ECZ 2021: HH led Central overall, with constituency-level PF pockets.', issueDrivers: ['farming inputs', 'roads', 'market access', 'civil service costs', 'peri-urban prices'], rationale: 'Central stays UPND-leaning but not a safe landslide. Farming inputs, roads and service delivery help HH, while PF-linked pockets and cost pressure keep the opposition competitive.', confidence: 'medium' },
    { name: 'Northern', voters: 705000, upnd: 32, pf: 48, lean: 'PF', classification: 'Opposition anchor', baseline2021: 'ECZ 2021: Lungu/PF led Northern.', issueDrivers: ['Bemba belt politics', 'PF structures', 'Mundubile home-region effect', 'fish/agriculture', 'rural roads'], rationale: 'Northern remains an opposition anchor because the PF baseline, Mundubile visibility and regional political machinery outweigh HH incumbency gains. UPND can reduce the gap through delivery proof, but not lead today.', confidence: 'high' },
    { name: 'North-Western', voters: 705000, upnd: 72, pf: 17, lean: 'UPND', classification: 'UPND anchor with mining scrutiny', baseline2021: 'ECZ 2021: HH won North-Western by a very large margin.', issueDrivers: ['new copperbelt jobs', 'mining benefits', 'local suppliers', 'roads', 'environmental governance'], rationale: 'North-Western remains a strong HH province. Mining benefit expectations and environmental/local supplier concerns reduce the margin from 2021 levels but do not create an opposition lead.', confidence: 'high' },
    { name: 'Western', voters: 660000, upnd: 69, pf: 17, lean: 'UPND', classification: 'UPND anchor', baseline2021: 'ECZ 2021: HH won Western heavily.', issueDrivers: ['Barotse development', 'roads', 'flood and water management', 'agriculture', 'decentralisation'], rationale: 'Western remains UPND-led. The model discounts for development impatience and service delivery expectations, but the 2021 baseline still gives HH a strong anchor.', confidence: 'high' },
    { name: 'Luapula', voters: 520000, upnd: 29, pf: 49, lean: 'PF', classification: 'Opposition anchor', baseline2021: 'ECZ 2021: Lungu/PF led Luapula strongly.', issueDrivers: ['PF legacy vote', 'Kalaba influence', 'fishing economy', 'rural roads', 'cost of living'], rationale: 'Luapula remains opposition-led. Kalaba pockets and PF legacy structures make it difficult for HH to lead, though a fragmented opposition and visible rural delivery could narrow the margin.', confidence: 'high' },
    { name: 'Muchinga', voters: 476246, upnd: 31, pf: 48, lean: 'PF', classification: 'Opposition leaning', baseline2021: 'ECZ 2021: Lungu/PF led Muchinga strongly.', issueDrivers: ['PF legacy vote', 'rural agriculture', 'roads', 'chiefdom networks', 'food prices'], rationale: 'Muchinga stays opposition-leaning due to the 2021 PF baseline and northern/eastern bloc dynamics. The opposition margin is trimmed because Lungu is no longer the candidate and ticket cohesion still needs proof.', confidence: 'high' },
  ],
