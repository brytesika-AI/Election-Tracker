...
const DEMO_HEADLINES: HeadlineInput[] = [
  ...
  { headline: 'Mundubile-Makebi lane gains momentum in opposition model', source: 'Lusaka Times' },
  { headline: 'Analysts warn 47 percent baseline leaves UPND exposed to 50 plus one runoff risk', source: 'News Diggers' },
  { headline: 'ECZ voter register and 226 constituencies reshape campaign arithmetic for 2026', source: 'ZNBC' },
